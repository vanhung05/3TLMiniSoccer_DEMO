    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PaymentConfigs", x => x.ConfigId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PeakMultiplier = table.Column<decimal>(type: "decimal(3,2)", precision: 3, scale: 2, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PricingRules_FieldTypes_FieldTypeId",
                        column: x => x.FieldTypeId,
                        principalTable: "FieldTypes",
                        principalColumn: "FieldTypeId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Users_Users_AssignedBy",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "UserId");
                    table.ForeignKey(
                        name: "FK_Bookings_Users_ConfirmedBy",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Contacts_Users_RespondedBy",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_DiscountCodes_Users_CreatedBy",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BookingSessions", x => x.SessionId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_FieldSchedules_Bookings_BookingId",
                        column: x => x.BookingId,
                        principalTable: "Bookings",
                        principalColumn: "BookingId",
                        onDelete: ReferentialAction.SetNull);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DiscountCodeUsages", x => x.UsageId);
                    table.ForeignKey(
                        name: "FK_DiscountCodeUsages_Bookings_BookingId",
                        column: x => x.BookingId,
                        principalTable: "Bookings",
                        principalColumn: "BookingId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BookingSessions_BookingId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DiscountCodes_CreatedBy",
                table: "DiscountCodes",
                column: "CreatedBy");

            migrationBuilder.CreateIndex(
                name: "IX_DiscountCodeUsages_BookingId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FieldSchedules_BookingId",
                table: "FieldSchedules",
                column: "BookingId");

            migrationBuilder.CreateIndex(
                name: "IX_FieldSchedules_FieldId_Date_StartTime_EndTime",
                table: "FieldSchedules",
                columns: new[] { "FieldId", "Date", "StartTime", "EndTime" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PricingRules_FieldTypeId",
                table: "PricingRules",
                column: "FieldTypeId");
