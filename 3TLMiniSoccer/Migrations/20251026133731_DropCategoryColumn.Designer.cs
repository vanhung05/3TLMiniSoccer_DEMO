...
namespace _3TLMiniSoccer.Migrations
{
    ...
    [Migration("20251026133731_DropCategoryColumn")]
    partial class DropCategoryColumn
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("_3TLMiniSoccer.Models.ProductType", b =>
                {
                    b.Property<int>("ProductTypeId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("_3TLMiniSoccer.Models.SessionOrder", b =>
                {
                    b.Property<int>("SessionOrderId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("SessionOrderId"));
            ...
            modelBuilder.Entity("_3TLMiniSoccer.Models.SessionOrderItem", b =>
                {
                    b.Property<int>("SessionOrderItemId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("SessionOrderItemId"));
                    ...
                    b.HasKey("SessionOrderItemId");

                    b.HasIndex("ProductId");

                    b.HasIndex("SessionOrderId");

                    b.ToTable("SessionOrderItems");
                });
            ...
            modelBuilder.Entity("_3TLMiniSoccer.Models.BookingSession", b =>
                {
                    ...
                    b.HasOne("_3TLMiniSoccer.Models.User", "Staff")
                        .WithMany()
            ...
            modelBuilder.Entity("_3TLMiniSoccer.Models.Product", b =>
                {
                    ...
                    b.HasOne("_3TLMiniSoccer.Models.ProductType", "ProductType")
                        .WithMany("Products")
            ...
            modelBuilder.Entity("_3TLMiniSoccer.Models.SessionOrder", b =>
                {
                    ...
                    b.HasOne("_3TLMiniSoccer.Models.BookingSession", "Session")
            ...
            modelBuilder.Entity("_3TLMiniSoccer.Models.SessionOrderItem", b =>
                {
                    ...
                    b.HasOne("_3TLMiniSoccer.Models.SessionOrder", "SessionOrder")
                        .WithMany("SessionOrderItems")
            ...
            modelBuilder.Entity("_3TLMiniSoccer.Models.SessionOrder", b =>
                {
                    b.Navigation("SessionOrderItems");
                });
